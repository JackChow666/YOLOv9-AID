...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='yolov9c-aid', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'lumban.yaml', help='dataset.yaml path')
